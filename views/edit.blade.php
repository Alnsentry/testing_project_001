...
<script>
    ...
    $(document).ready(function() {
        ...
        function updateKodeJenis(latestID) {
            ...
            // Mohon maaf dikarenakan kurang informasi, dan saya tidak dapat mencoba terlebih dahulu
            // dengan source yang terbatas saya hanya dapat beranggapan bahwa kodeJenis untuk
            // kodeKategori, kodeKlasifikasi dan tahunMesin dapat berubah rubah tetapi nomor urut akan
            // tetap, maka dari itu kita dapat membuatnya seperti berikut
            var nomorUrut = $('#kode_jenis').val().split(' - ')[2];
            var kodeJenis = kodeKategori + ' - ' + kodeKlasifikasi + ' - ' + nomorUrut + ' - ' + tahunMesin;
            $('#kode_jenis').val(kodeJenis);
            // Jika seluruh kodeJenis tidak dapat berubah solusinya adalah tidak perlu menyertakan
            // kodeJenis saat sedang melakukan update data
